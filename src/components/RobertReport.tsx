...
export const RobertReport: React.FC<RobertReportProps> = ({ isOpen, onClose, stats, history, students }) => {
  const [activeTab, setActiveTab] = useState<'health' | 'demographics'>('health');
